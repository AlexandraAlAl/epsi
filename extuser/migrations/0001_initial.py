    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firstname', models.CharField(verbose_name='Фамилия', max_length=40, blank=True, null=True)),
                ('lastname', models.CharField(verbose_name='Имя', max_length=40, blank=True, null=True)),
